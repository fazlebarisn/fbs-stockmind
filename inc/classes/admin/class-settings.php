...
class Settings
{
    ...
    public function save_settings()
    {
        $settings_to_save = [
            ...
            'prediction_accuracy_threshold' => floatval($_POST['prediction_accuracy_threshold'] ?? 0.8),
            'reminder_advance_days' => absint($_POST['reminder_advance_days'] ?? 5),
            'max_reminder_attempts' => absint($_POST['max_reminder_attempts'] ?? 3),
    ...
    private function get_all_settings()
    {
        return [
            ...
            'prediction_accuracy_threshold' => fbs_stockmind_get_option('prediction_accuracy_threshold', 0.8),
            'reminder_advance_days' => fbs_stockmind_get_option('reminder_advance_days', 5),
            'max_reminder_attempts' => fbs_stockmind_get_option('max_reminder_attempts', 3),
